...
FavCardCategoryEnum getFavCardCategoryEnum({required String cardCategory}) {
  return FavCardCategoryEnum.values.firstWhere((e) => e.toString() == 'FavCardCategoryEnum.${cardCategory.toLowerCase()}');
}

FavCardCategoryModel getFavCardCategoryFromEnum({required FavCardCategoryEnum favCardCategoryEnum}) {
  switch (favCardCategoryEnum) {
    case FavCardCategoryEnum.top:
      return const FavCardCategoryModel(
          name: FavCardCategoryEnum.top, color: Color(0xFFBE94C6), imageAddress: "assets/fav_card/fav_category/top.svg");
    ...
    case FavCardCategoryEnum.life:
      return const FavCardCategoryModel(
          name: FavCardCategoryEnum.life, color: Colors.green, imageAddress: "assets/fav_card/fav_category/life.svg");
    ...
    case FavCardCategoryEnum.job:
      return const FavCardCategoryModel(
          name: FavCardCategoryEnum.job, color: Color(0xFFF3C6D5), imageAddress: "assets/fav_card/fav_category/job.svg");
    ...
    case FavCardCategoryEnum.tv:
      return const FavCardCategoryModel(
          name: FavCardCategoryEnum.tv, color: Color(0xFFBE94C6), imageAddress: "assets/fav_card/fav_category/tv.svg");
    ...
    case FavCardCategoryEnum.recommended:
      return const FavCardCategoryModel(
          name: FavCardCategoryEnum.popular, color: Color(0xFFBAE9FF), imageAddress: "assets/fav_card/fav_category/popular.svg");
    case FavCardCategoryEnum.popular:
      return const FavCardCategoryModel(
          name: FavCardCategoryEnum.recommended, color: Color(0xFFF3C7D4), imageAddress: "assets/fav_card/fav_category/recommended.svg");
  }
}
