...
class ChatMessagesState with _$ChatMessagesState {
  ...
  const factory ChatMessagesState.errorState(
      {required AppException appException}) = ErrorState;
  const factory ChatMessagesState.chatMessagesFetched(
      {required List<TextMessage> chatMessages}) = ChatMessagesFetched;
}
